...
def build_simple_rbf(net, landmarks, bw, reg_out,
    ...
    net = Network(train.dim, n_land, dtype=kw['dtype'])
...
def build_spatsep_rbf(net, landmarks, bw, reg_out,
                     reg_out_bias=0, scale_reg_by_n=False,
                     dtype=tf.float32,
                     init_out=None,
                     init_out_bias=None,
    ...
    n_land = landmarks.shape[0]
    net = Network(train.dim, 2*n_land, dtype=kw['dtype'])
