...
for(i in 1:bag_iter){
  ...
  bag_allvars_mat[, i] = getBags(bags = bags_temp$bag_fit, vars = file_and_survey_vars, newdata = pew_data)$bags_newdata
...
### Empty bags
When we use all the variables, there are empty bags in the survey data
